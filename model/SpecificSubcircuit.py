class SpecificSubcircuit():
    ...
    def __init__(self, subcircuit_template_id, is_black_box, circuit_id, connect, rotate, position, current, circle, elementDOM):
    ...
    def __repr__(self) -> str:
        ...
        connect={self.connect}, rotate={self.rotate}, position={self.position}, current={self.current}, circle={self.circle}, elementDOM={self.elementDOM})"